...
def get_target_for_supervisor(user_id=None, include_user=False, months=None, years=None):
    ...
    if user_id:
        ...
        user_target_month_products = UserTargetMonthProduct.objects.filter(usermonth__date__year__in=years, usermonth__date__month__in=months, usermonth__user=user).values('product__id','product', 'product__price', 'product__nom').distinct()
        ...
        for user_target_month_product in user_target_month_products:
            ...
            target_quantity = UserTargetMonthProduct.objects.filter(usermonth__date__year__in=years, usermonth__date__month__in=months, product__id=user_target_month_product['product__id']).aggregate(total=Sum('quantity'))['total']
            targets.append(round(target_quantity, 2))
